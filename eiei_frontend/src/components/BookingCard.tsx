...
export default function BookingCard({companyName,id,reservationDate,onRemoveReservation,onEditReservation}:{companyName:string,id:string,reservationDate:string,onRemoveReservation?:Function,onEditReservation?:Function}){
    return(
  <div className="w-full h-[300px] rounded-xl shadow-lg bg-white">
    <div className="w-full h-[70%] p-[10px] text-black align-center item-center">
